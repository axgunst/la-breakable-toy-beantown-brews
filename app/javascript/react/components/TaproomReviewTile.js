    ...
    editForm = (
      <form onSubmit={handleEditReview}>
        ...
        <fieldset>
          ...
          <input
            type="radio"
            name="group_accommodations_rating"
            onChange={handleInputChange}
            value="1"
            id="1"
          />
        ...
        <label htmlFor="favorite_beer">
          ...
          <textarea
            ...
            type="text"
            name="favorite_beer"
            value={editedReview.favorite_beer}
            onChange={handleInputChange}
          />
        </label>
    ...
    <div className="review-tile">
      <div className="grid-x">
        <div className="small-12 medium-12 large-12">
          <div className="grid-x">
            <div className="small-8 medium-12 large-12">
              <div className="grid-x">
                <h3 className="cell small-4 text-left username">
                  {props.username}
                </h3>
                <h4>{props.title}</h4>
                <ul>
                  <li className="cell small-4 text-left">
                    Overall rating: {props.overall_rating}
                  </li>
                  <li className="cell small-4 text-left">
                    Service rating: {props.service_rating}
                  </li>
                  <li className="cell small-4 text-left">
                    Vibes rating: {props.ambience_rating}
                  </li>
                  <li className="cell small-4 text-left">
                    Seating availability for a group:{" "}
                    {props.group_accommodations_rating}
                  </li>
                  <li className="cell small-4 text-left">
                    Favorite beer tried this trip: {props.favorite_beer}
                  </li>
                  ...
                  <li>
                    <button onClick={displayEditReview}>Edit</button>
                  </li>
                </ul>
